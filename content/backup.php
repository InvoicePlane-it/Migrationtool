...
<a href="<?php echo $base_url ?>engine/save_backup.php" id="btn_backup" class="btn btn-lg btn-warning">
    <i class="fa fa-history"></i>&nbsp; Save Backup
</a>

<br/><br/>

<a href="<?php echo $base_url ?>step/conversion" id="btn_continue" class="btn btn-lg btn-default">
